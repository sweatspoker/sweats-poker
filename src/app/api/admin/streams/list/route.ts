...
export async function GET(request: NextRequest) {
  ...
  let q = admin
    ...
    .from("streams")
    .select(
      "stream_id, name, venue_id, status, start_time, end_time, sb_minor, bb_minor, ante_minor, straddle_minor, game_type, ipo_lead_open_minutes, ipo_lead_close_minutes, notes, created_at, updated_at"
    )
