-- 0053: extend get_player_stats with the bid-decision metrics the panel
-- needs flat in the totals object: win_rate_pct, avg_final_share_value_minor,
-- avg_clearing_premium_minor. Lets the client render a flat label/value
-- list without computing aggregates from the per-session array.
