...
cur.execute("SELECT players.record_consent('p_c15', 'v1.0', 'operator_attestation', NULL, NULL, NULL)")
...
cur.execute("DELETE FROM players.consent_releases WHERE player_id='p_c15'")
